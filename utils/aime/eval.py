...
AIME23_25_SYSTEM_PROMPT = (
    "You are a helpful assistant that solves math problems step by step. "
    "Please reason step by step, and put your final answer within \\boxed{}."
)


class Aime23_25Evaluator(BaseMathEvaluator):
    """AIME 23-25: problem/answer jsonl, \\boxed extraction, grade_answer for LaTeX equivalence."""
    ...
    def build_prompt(self, tokenizer, question: str, *, enable_thinking: bool = False) -> str:
        messages = [
            {"role": "system", "content": AIME23_25_SYSTEM_PROMPT},
...
def evaluate_aime23_25_accuracy(
    model,
    tokenizer,
    test_path: str,
    ...
    """Convenience entry point: run AIME 23-25 evaluation via the base evaluator."""
    return Aime23_25Evaluator().evaluate(
        model=model,
        tokenizer=tokenizer,
        test_path=test_path,
        device=device,
